...
echo_bold
echo_bold "Stopping SPIRE server and agents in west-1"
echo_bold
...
minikube -p west-1 ssh 'sudo rm -rf /var/run/spire/agent/*'
minikube -p west-1 ssh 'sudo rm -rf /var/run/spire/global-agent/*'
